package eu.opertusmundi.admin.test.support;
...
public class BaseIntegrationTest {
    ...
    protected static final String KEYCLOAK_TOPIO_CLIENT = "topio-admin";
    ...
    private static void setDynamicProperties(DynamicPropertyRegistry registry) throws IOException {
        /**
         * Data source and database migration properties
         */
